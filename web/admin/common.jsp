                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a class="admin"><i class="fa fa-database"></i> 信息管理 <span
                                    class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="userinfo.jsp">用户信息</a>
                                    </li>
                                    <li><a href="newsinfo.jsp">新闻信息</a>
                                    </li>


                                    <li><a href="leaveinfo.jsp">留言信息</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a class="admin"><i class="fa fa-calculator"></i> 销售信息 <span
                                    class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="orderinfo.jsp">订单信息</a>
                                    </li>
                                    <li><a href="carinfo.jsp">车辆信息</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="loginbtn">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                ...
                                <li><a href="../login.jsp"><i class="fa fa-sign-out pull-right"></i>
                                    注销</a>
                                </li>
                            </ul>
                        </li>
