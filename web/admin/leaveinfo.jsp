<%@ page import="com.codey.bean.Message" %>
<%@ page import="com.codey.dao.MessageDao" %>
                    ...
                    <div class="x_content">
                        <table class="table table-striped responsive-utilities jambo_table bulk_action">
                            ...
                            <tr class="even pointer">
                                ...
                                <td class=" "><%= message.getUsername()%>
                                </td>
                                <td class=" "><%= message.getTime()%>
                                </td>
                                <td class=" "><%= message.getContent()%><i
                                        class="success fa fa-long-arrow-up"></i>
                                </td>
                                <td class=" last">
                                    <button type="button" class="btn btn-round btn-primary">回复
                                    </button>
                                    <a href=<%="../admin/deletemessage?username="
                                            +message.getUsername()+"&pubtime="+message.getTime()%>>
